...
athlete_colors <- c(
  "KERLEY Fred" = "#362FD9",
  "SIMBINE Akani" = "#9fc610",
  "OMANYALA Ferdinand" = "black",
  "TEBOGO Letsile" = "#991b1b",
  "BROMELL Trayvon" = "#DC0000",
  "BLAKE Yohan" = "#494a55",
  "AZU Jeremiah" = "#F36C21",
  "FALL Mouhamadou" = "#850000",
  "MACHMOUR Chakir" = "#4b64ff"
)
...
Rabat_100m_men_rankings_bump_chart <- Rabat_100m_men |>
  ...
  geom_text(
    data = Rabat_100m_men |>
      filter(Mark == 100),
    aes(label = glue("{Time}s"), col = Athlete), hjust = 0, nudge_x = 5, size = 5, 
  ...
  labs(
    ...
    subtitle = "Rabat 2023: Men's 100m Race Analysis",
    caption = cap
  )

# Save plot
ggsave("Rabat_100m_men_rankings_2023.png", width = 11, height = 9, bg = "white")
